...
class Brand(models.Model):
    ...
    prop = models.CharField(db_column='PROP', max_length=2, blank=True, null=True)  # Field name made lowercase.
    classes = models.CharField(db_column='CLASSES', max_length=2, blank=True, null=True)  # Field name made lowercase.
...
class Estimate(models.Model):
    ...
    dateid = models.DateField(db_column='DateID')  # Field name made lowercase.
...
class Kgretshop(models.Model):
    sdate = models.DateTimeField()
    shopid = models.CharField(max_length=4)
    costvalue = models.DecimalField(max_digits=12, decimal_places=2)
    reth = models.DecimalField(max_digits=12, decimal_places=2)
...
class Kgshop12Lost(models.Model):
    sdate = models.DateTimeField()
    shopid = models.CharField(max_length=4)
    shopname = models.CharField(max_length=64)
    deptid = models.IntegerField()
    costvalue = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    lostvalue = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    lrate = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'KGshop12lost'


class Kgshop15Lost(models.Model):
    sdate = models.DateTimeField()
    shopid = models.CharField(max_length=4)
    shopname = models.CharField(max_length=64)
    costvalue = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'KGshop15lost'


class Kgshop17Lost(models.Model):
    sdate = models.DateTimeField()
    shopid = models.CharField(max_length=4)
    shopname = models.CharField(max_length=64)
    deptid = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'KGshop17lost'


class Kgshopretsale(models.Model):
    sdate = models.DateTimeField()
    shopid = models.CharField(max_length=4)
    shopsale = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    ret = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'KGshopretsale'


class Kgshopretsaleitem(models.Model):
    shopid = models.CharField(max_length=4)
    shopname = models.CharField(max_length=64)
    sdate = models.DateTimeField()
    ...
    cashierid = models.CharField(db_column='CashierID', max_length=4, blank=True, null=True)  # Field name made lowercase.
    goodsid = models.IntegerField()
    goodsname = models.CharField(max_length=64)
    deptid = models.IntegerField(db_column='DeptID')  # Field name made lowercase.
    amount = models.DecimalField(db_column='Amount', max_digits=10, decimal_places=4)  # Field name made lowercase.
    sale = models.DecimalField(max_digits=12, decimal_places=2)

    class Meta:
        managed = False
        db_table = 'KGshopretsaleitem'


class Knegativestock(models.Model):
    ...
    shopname = models.CharField(max_length=32, blank=True, null=True)
    deptid = models.IntegerField(blank=True, null=True)
    deptidname = models.CharField(max_length=32, blank=True, null=True)
    qtyz = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    qtyl = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    zhonbi = models.DecimalField(max_digits=12, decimal_places=4, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'KNegativestock'
...
class Kshopsale(models.Model):
    ...
    sdateold = models.DateTimeField(db_column='Sdateold', blank=True, null=True)  # Field name made lowercase.
...
class RptSaleshop(models.Model):
    sdate = models.DateTimeField(db_column='SDate')  # Field name made lowercase.
    shopid = models.CharField(db_column='ShopID', max_length=4)  # Field name made lowercase.
    tradeprice = models.DecimalField(db_column='TradePrice', max_digits=12, decimal_places=2)  # Field name made lowercase.
    tradenumber = models.IntegerField(db_column='TradeNumber')  # Field name made lowercase.
    salerate = models.DecimalField(db_column='SaleRate', max_digits=5, decimal_places=2)  # Field name made lowercase.
    salevalue = models.DecimalField(db_column='SaleValue', max_digits=12, decimal_places=2)  # Field name made lowercase.
    discvalue = models.DecimalField(db_column='DiscValue', max_digits=12, decimal_places=2)  # Field name made lowercase.
    saletaxvalue = models.DecimalField(db_column='SaleTaxValue', max_digits=12, decimal_places=2)  # Field name made lowercase.
    costvalue = models.DecimalField(db_column='CostValue', max_digits=12, decimal_places=2)  # Field name made lowercase.
    msaletotal = models.DecimalField(db_column='MSaleTotal', max_digits=12, decimal_places=2)  # Field name made lowercase.
    mdisctotal = models.DecimalField(db_column='MDiscTotal', max_digits=12, decimal_places=2)  # Field name made lowercase.
    mtaxtotal = models.DecimalField(db_column='MTaxTotal', max_digits=12, decimal_places=2)  # Field name made lowercase.
    mcostvalue = models.DecimalField(db_column='MCostValue', max_digits=12, decimal_places=2)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'RPT_SaleShop'
        unique_together = (('SDate', 'ShopID'),)


class SalesProBak(models.Model):
    sdate = models.DateTimeField(db_column='Sdate')  # Field name made lowercase.
...
class Adpriced(models.Model):
    ...
    dqhsjj = models.DecimalField(db_column='Dqhsjj', max_digits=11, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
...
class BasGoods(models.Model):
    ...
    barcodeid = models.CharField(db_column='BarcodeID', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class BasGoods99(models.Model):
    grpcode = models.CharField(db_column='Grpcode', max_length=20)  # Field name made lowercase.
    name = models.CharField(db_column='Name', max_length=64)  # Field name made lowercase.
    unitname = models.CharField(db_column='UnitName', max_length=64)  # Field name made lowercase.
    spec = models.CharField(db_column='Spec', max_length=50, blank=True, null=True)  # Field name made lowercase.
    brandid = models.CharField(db_column='BrandID', max_length=64)  # Field name made lowercase.
    deptid = models.CharField(db_column='DeptID', max_length=50)  # Field name made lowercase.
    deptname = models.CharField(db_column='DeptName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    goodsid = models.CharField(db_column='GoodsID', max_length=20)  # Field name made lowercase.
    shopid = models.CharField(db_column='ShopID', max_length=20)  # Field name made lowercase.
    venderid = models.IntegerField(db_column='VenderID')  # Field name made lowercase.
    cost = models.DecimalField(db_column='Cost', max_digits=12, decimal_places=4)  # Field name made lowercase.
    costtaxrate = models.DecimalField(db_column='CostTaxRate', max_digits=12, decimal_places=4)  # Field name made lowercase.
    dkrate = models.DecimalField(db_column='DKRate', max_digits=4, decimal_places=2)  # Field name made lowercase.
    promflag = models.IntegerField(db_column='PromFlag')  # Field name made lowercase.
    startdate = models.DateTimeField(db_column='StartDate', blank=True, null=True)  # Field name made lowercase.
    enddate = models.DateTimeField(db_column='EndDate', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'bas_goods99'
        unique_together = (('GoodsID', 'ShopID', 'VenderID'),)


class BasGroup(models.Model):
    grpcode = models.CharField(db_column='GRPCODE', primary_key=True, max_length=20)  # Field name made lowercase.
...
class BasPaytype(models.Model):
    ...
    name = models.CharField(db_column='Name', max_length=16, blank=True, null=True)  # Field name made lowercase.
    paytypesortid = models.CharField(db_column='PayTypeSortID', max_length=1, blank=True, null=True)  # Field name made lowercase.
    paytypeday = models.IntegerField(db_column='PayTypeDay', blank=True, null=True)  # Field name made lowercase.
    ...
    runtype = models.IntegerField(db_column='RunType', blank=True, null=True)  # Field name made lowercase.
    dkflag = models.IntegerField(db_column='DkFlag', blank=True, null=True)  # Field name made lowercase.
...
class BasShop(models.Model):
    ...
    khbank = models.CharField(db_column='KHBank', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class BasShopRegion(models.Model):
    ...
    shoptype = models.IntegerField(db_column='ShopType', blank=True, null=True)  # Field name made lowercase.
...
class BasStub(models.Model):
    itemid = models.CharField(db_column='ITEMID', primary_key=True, max_length=20)  # Field name made lowercase.
...
class BasSuppLand(models.Model):
    ...
    lastlandtime = models.DateTimeField(db_column='LASTLANDTIME', blank=True, null=True)  # Field name made lowercase.
...
class BasSupplier(models.Model):
    suppcode = models.CharField(db_column='Suppcode', max_length=8)  # Field name made lowercase.
    chnm = models.CharField(db_column='Chnm', max_length=64)  # Field name made lowercase.
...
class BillIn(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'bill_in'
        unique_together = (('Code', 'Grpcode', 'Shopcode', 'Chdate', 'Spercode', 'Orderstyle'),)
...
class BillInd(models.Model):
    ...
    pname = models.CharField(db_column='Pname', max_length=64, blank=True, null=True)  # Field name made lowercase.
    classes = models.CharField(db_column='Classes', max_length=20, blank=True, null=True)  # Field name made lowercase.
    unit = models.CharField(db_column='Unit', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class Billhead0(models.Model):
    ...
    advance = models.DecimalField(db_column='Advance', max_digits=14, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    seenum = models.IntegerField(db_column='Seenum', blank=True, null=True)  # Field name made lowercase.
    status = models.CharField(db_column='Status', max_length=6, blank=True, null=True)  # Field name made lowercase.
    grpcode = models.CharField(db_column='Grpcode', max_length=10)  # Field name made lowercase.
    contracttype = models.CharField(db_column='Contracttype', max_length=2, blank=True, null=True)  # Field name made lowercase.
    concode = models.CharField(db_column='Concode', max_length=20, blank=True, null=True)  # Field name made lowercase.
    vendername = models.CharField(db_column='Vendername', max_length=64, blank=True, null=True)  # Field name made lowercase.
    address = models.CharField(db_column='Address', max_length=64, blank=True, null=True)  # Field name made lowercase.
    printnum = models.IntegerField(db_column='Printnum', blank=True, null=True)  # Field name made lowercase.
    premoney = models.DecimalField(db_column='PreMoney', max_digits=14, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    curdxvalue = models.FloatField(db_column='CurDXValue')  # Field name made lowercase.
    curdxdiffvalue = models.CharField(db_column='CurDXDiffValue', max_length=12)  # Field name made lowercase.
    beginsdate = models.DateTimeField(db_column='BeginSDate', blank=True, null=True)  # Field name made lowercase.
    endsdate = models.DateTimeField(db_column='EndSDate', blank=True, null=True)  # Field name made lowercase.
...
class Billhead0Copy(models.Model):
    sheetid = models.CharField(db_column='SheetID', primary_key=True, max_length=16)  # Field name made lowercase.
    shopid = models.CharField(db_column='ShopID', max_length=4)  # Field name made lowercase.
    venderid = models.IntegerField(db_column='VenderID')  # Field name made lowercase.
    payablemoney = models.DecimalField(db_column='PayableMoney', max_digits=14, decimal_places=4)  # Field name made lowercase.
...
class Billheadcust(models.Model):
    ...
    custid = models.CharField(db_column='custID', max_length=4)  # Field name made lowercase.
    ...
    class Meta:
        ...
        unique_together = (('SheetID', 'custID', 'TaxRate'),)
...
class Billheaditem0(models.Model):
    ...
    costvalue = models.DecimalField(db_column='CostValue', max_digits=14, decimal_places=4)  # Field name made lowercase.
    costtaxvalue = models.DecimalField(db_column='CostTaxValue', max_digits=14, decimal_places=4)  # Field name made lowercase.
    costtaxrate = models.DecimalField(db_column='CostTaxRate', max_digits=4, decimal_places=2)  # Field name made lowercase.
    ...
    dkrate = models.DecimalField(db_column='DKRate', max_digits=5, decimal_places=2)  # Field name made lowercase.
    jdate = models.DateTimeField(db_column='JDate', blank=True, null=True)  # Field name made lowercase.
    standvalue = models.DecimalField(db_column='StandValue', max_digits=14, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    closevalue = models.DecimalField(db_column='CloseValue', max_digits=14, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
...
class Goodsshop(models.Model):
    ...
    noretflag = models.IntegerField(db_column='Noretflag')  # Field name made lowercase.
...
class Goodsshop99(models.Model):
    shopid = models.CharField(db_column='ShopID', max_length=4)  # Field name made lowercase.
    goodsid = models.IntegerField(db_column='GoodsID')  # Field name made lowercase.
    normalprice = models.DecimalField(db_column='NormalPrice', max_digits=10, decimal_places=2)  # Field name made lowercase.
    price = models.DecimalField(db_column='Price', max_digits=10, decimal_places=2)  # Field name made lowercase.
...
class Kggoodsret(models.Model):
    ...
    deptid = models.IntegerField(db_column='DeptID')  # Field name made lowercase.
    deptname = models.CharField(db_column='DeptName', max_length=64, blank=True, null=True)  # Field name made lowercase.
    goodsid = models.IntegerField()
    goodsname = models.CharField(max_length=64, blank=True, null=True)
    xamount = models.DecimalField(db_column='xAmount', max_digits=14, decimal_places=6, blank=True, null=True)  # Field name made lowercase.
    salevalue = models.DecimalField(max_digits=14, decimal_places=2, blank=True, null=True)
    discvalue = models.DecimalField(db_column='DiscValue', max_digits=14, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    truevalue = models.DecimalField(max_digits=14, decimal_places=2, blank=True, null=True)
    saletype = models.CharField(db_column='SaleType', max_length=10, blank=True, null=True)  # Field name made lowercase.
    price = models.DecimalField(db_column='Price', max_digits=14, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
class Kwholesale(models.Model):
    sdate = models.DateTimeField()
    shopid = models.CharField(max_length=4)
    deptid = models.CharField(max_length=8)
    venderid = models.IntegerField(blank=True, null=True)
    qty = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    salevalue = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    costvalue = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
...
class Kwsaletop(models.Model):
    sdate = models.DateTimeField()
    shopcode = models.CharField(max_length=4, blank=True, null=True)
    classsx = models.IntegerField(blank=True, null=True)
    classxnm = models.CharField(max_length=16, blank=True, null=True)
    pcode = models.IntegerField(blank=True, null=True)
    barcode = models.CharField(max_length=14, blank=True, null=True)
    pname = models.CharField(db_column='pName', max_length=64, blank=True, null=True)  # Field name made lowercase.
    num = models.DecimalField(max_digits=16, decimal_places=4, blank=True, null=True)
    svalue = models.DecimalField(max_digits=16, decimal_places=4, blank=True, null=True)
    scost = models.DecimalField(max_digits=16, decimal_places=4, blank=True, null=True)
    gpvalue = models.DecimalField(db_column='GPValue', max_digits=16, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    gprate = models.DecimalField(db_column='GPRate', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    closeqty = models.DecimalField(db_column='CloseQty', max_digits=16, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    closevalue = models.DecimalField(db_column='CloseValue', max_digits=16, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    pmflag = models.CharField(db_column='PMFlag', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class Kwsaletop10(models.Model):
    sdate = models.DateTimeField()
    shopcode = models.CharField(max_length=4, blank=True, null=True)
    ...
    closevalue = models.DecimalField(db_column='CloseValue', max_digits=16, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    pmflag = models.CharField(db_column='PMFlag', max_length=20, blank=True, null=True)  # Field name made lowercase.
    cprice = models.DecimalField(max_digits=12, decimal_places=6, blank=True, null=True)
    price = models.DecimalField(max_digits=12, decimal_places=6, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'kwsaletop10'
...
class Pubinfo(models.Model):
    infocode = models.CharField(db_column='InfoCode', max_length=20)  # Field name made lowercase.
    ...
    subtime = models.DateTimeField(db_column='SubTime', blank=True, null=True)  # Field name made lowercase.
    content = models.TextField(db_column='Content', blank=True, null=True)  # Field name made lowercase.
    title = models.CharField(db_column='Title', max_length=1024, blank=True, null=True)  # Field name made lowercase.
    depart = models.CharField(db_column='Depart', max_length=200, blank=True, null=True)  # Field name made lowercase.
    grpcode = models.CharField(db_column='GrpCode', max_length=20, blank=True, null=True)  # Field name made lowercase.
    ...
    departname = models.CharField(db_column='DepartName', max_length=400, blank=True, null=True)  # Field name made lowercase.
    mailpath = models.CharField(db_column='MailPath', max_length=200, blank=True, null=True)  # Field name made lowercase.
...
class Reconcil(models.Model):
    ...
    beginday = models.IntegerField(blank=True, null=True)
...
class Reconcilitem(models.Model):
    ...
    pid = models.CharField(max_length=2)
...
class SalesProTemp(models.Model):
    sdate = models.DateTimeField(db_column='Sdate')  # Field name made lowercase.
    grpcode = models.CharField(db_column='Grpcode', max_length=20)  # Field name made lowercase.
    shopcode = models.CharField(db_column='Shopcode', max_length=20)  # Field name made lowercase.
    sstyle = models.CharField(db_column='Sstyle', max_length=20)  # Field name made lowercase.
...
class Serialnumber(models.Model):
    ...
    name = models.CharField(db_column='Name', max_length=64)  # Field name made lowercase.
    flag = models.IntegerField(db_column='Flag')  # Field name made lowercase.
    serialnumber = models.IntegerField(db_column='SerialNumber')  # Field name made lowercase.
    resetdate = models.DateField(db_column='ResetDate')  # Field name made lowercase.
    dailyreset = models.IntegerField(db_column='DailyReset')  # Field name made lowercase.
    servertranflag = models.IntegerField(db_column='ServerTranFlag')  # Field name made lowercase.
    sheetflag = models.IntegerField(db_column='SheetFlag')  # Field name made lowercase.
    aftercheckmoduleid = models.CharField(db_column='AfterCheckModuleID', max_length=255, blank=True, null=True)  # Field name made lowercase.
    deptcode = models.CharField(db_column='DeptCode', max_length=6, blank=True, null=True)  # Field name made lowercase.
...
class Stock(models.Model):
    goodscostid = models.CharField(db_column='GoodsCostID', max_length=255)  # Field name made lowercase.
    procode = models.CharField(db_column='Procode', max_length=20)  # Field name made lowercase.
...
class Stockday(models.Model):
    shopcode = models.CharField(max_length=4, blank=True, null=True)
    pcode = models.IntegerField(blank=True, null=True)
    qty = models.DecimalField(db_column='Qty', max_digits=16, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    costvalue = models.DecimalField(db_column='CostValue', max_digits=16, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
