...
class BillInForm(forms.Form):
    shopcode = forms.CharField(widget=forms.TextInput(attrs={"id":"shopCode","name":"shopCode","style":"width:200px","readonly":"readonly"}),
                               required=False)
    code = forms.CharField(widget=forms.TextInput(attrs={"id":"code","name":"code","style":"width:200px"}),required=False)
...
class AdPriceForm(BillInForm):
    ...
    orderStyle = forms.ChoiceField(widget=forms.Select(attrs={"name":"orderStyle","style":"width:200px"}),choices=CHIOCE_LIST)
